...
public class fragmentKuisMTK2 extends Fragment implements View.OnClickListener{
    ...
    public fragmentKuisMTK2(){}
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        fragmentLayout = inflater.inflate(R.layout.activity_fragment_kuis_mtk2,container,false);
...
//        Button spoiler11 = (Button) fragmentLayout.findViewById(R.id.spoiler1_1);
        ...
        soalDikerjakan = userData.getInt(getString(R.string.Dikerjakan_MTK_Latihan2),-1);
    ...
    public void changeIsiKuis(Integer nomor){
        ...
        if(nomor <= restNumb) {
            if ( nomor >= restNumb){
                if (score >= score_mtk_lat2){
                    score_mtk_lat2 = score;
                    updateNilai();
                    Intent intent;
...
//        Jika salah maka yang benar di ganti warna, dan yang dipilih berganti warna menjadi abu2
    ...
    public void updateNilai(){
        ...
        editor.putInt(getString(R.string.SCORE_MTK_Latihan2), score_mtk_lat2);
