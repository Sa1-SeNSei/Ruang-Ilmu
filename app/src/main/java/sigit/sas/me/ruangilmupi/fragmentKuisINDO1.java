...
public class fragmentKuisINDO1 extends Fragment implements View.OnClickListener {
    ...
    Integer score_indo_lat1;


    public TextView skore;


    public fragmentKuisINDO1(){}
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        fragmentLayout = inflater.inflate(R.layout.activity_fragment_kuis_indo1,container,false);
...
//        Button spoiler11 = (Button) fragmentLayout.findViewById(R.id.spoiler1_1);
        ...
        soalDikerjakan = userData.getInt(getString(R.string.Dikerjakan_INDO_Latihan1),-1);
    ...
    public void changeIsiKuis(Integer nomor){
        ...
        if(nomor <= restNumb) {
            if ( nomor >= restNumb){
                if (score >= score_indo_lat1){
                    score_indo_lat1 = score;
                    updateNilai();
                    Intent intent;
