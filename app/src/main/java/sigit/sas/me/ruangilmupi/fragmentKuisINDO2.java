...
public class fragmentKuisINDO2 extends Fragment implements View.OnClickListener {
    ...
    Integer score_indo_lat2;


    public TextView skore;


    public fragmentKuisINDO2(){}
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        fragmentLayout = inflater.inflate(R.layout.activity_fragment_kuis_indo2,container,false);
        ...
        buttonk.add(btnC);
        buttonk.add(btnD);
        soalString = getResources().getStringArray(R.array.SoalIndo_Lat2);
        pilihan = getResources().getStringArray(R.array.ABC_Indo_Lat2);
        jumlahpilhan = getResources().getIntArray(R.array.JumlahPilihanIndo_Lat2);
        penjelasankuis = getResources().getStringArray(R.array.PenjelasanJawabanIndo_Lat2);
        jawabanPiliihanKuis = getResources().getIntArray(R.array.JawabanKuisIndo_Lat2);
...
//        Button spoiler11 = (Button) fragmentLayout.findViewById(R.id.spoiler1_1);
        ...
        soalDikerjakan = userData.getInt(getString(R.string.Dikerjakan_INDO_Latihan2),-1);
    ...
    public void changeIsiKuis(Integer nomor){
        ...
        if(nomor <= restNumb) {
            if ( nomor >= restNumb){
                if (score >= score_indo_lat2){
                    score_indo_lat2 = score;
                    updateNilai();
                    Intent intent;
...
//        Jika jawaban benar maka Button akan berganti warna menjadi emas
        ...
        if(jawaban == jawabanBenar){
            ...
            pw.showAtLocation(fragmentLayout.findViewById(R.id.kuisINDO2), Gravity.CENTER, 0, 0);
...
//        Jika salah maka yang benar di ganti warna, dan yang dipilih berganti warna menjadi abu2
    ...
    public void updateNilai(){
        ...
        editor.putInt(getString(R.string.SCORE_INDO_Latihan2), score_indo_lat2);
